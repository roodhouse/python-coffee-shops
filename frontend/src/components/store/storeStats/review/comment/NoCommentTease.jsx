  ...
  return (
    <>
        { addComment ? (
            ...
            <div id={`noCommentContainer-${count}`} className='underline cursor-pointer' onClick={(event) => handleClick(count, event)}>
                ...
                count === 1 ? (
                    ...
                    count === 2 ? (
                        ...
                        <div id="commentActionContainer" className='flex mt-9 justify-between'>
                            <div id={`noCommentContainer-${count}`} onClick={(event) => handleClick(count, event)} className='cursor-pointer underline text-right'>
                                <p>Leave a comment</p>
                        </div>
                        {addReviews ? (
                        ...
                        count === 3 ? (
                            ...
                            <div id="storeEditCommentContainer" onClick={(event) => handleClick(count, event)} className='cursor-pointer underline text-right mt-9'>
